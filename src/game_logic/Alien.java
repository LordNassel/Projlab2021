...
public class Alien extends Movable  {
    ...
    public void Step(){
        //Mivel nem igaz�n tud semmit semmirol, illetve nem nagyon tud semmit csinalni minden lepesben banyaszik,

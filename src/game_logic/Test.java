...
public class Test {
	...
	{
		System.out.println("Radioaktív maggal rendelkező aszteroida teszt\n");
		System.out.println("Az aszteroida teljesen megfúrt?\n");
		System.out.println("0. Igen ");
		System.out.println("1. Nem\n");
		switch(this.inputmanager())
		...
		case 0:
			...
			System.out.println("Radioaktív maggal rendelkező aszteroida felrobbant.\n");
			this.TestMgr();
			break;
		case 1:
			Asteroid a2 = new Asteroid("a2", uran, false);
			uran.GetExposed(false, a2);
			System.out.println("Radioaktív maggal rendelkező aszteroida nem robbant fel.\n");
			this.TestMgr();
			break;
		default:
			this.TestMgr();	

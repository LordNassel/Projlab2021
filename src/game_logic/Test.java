...
public class Test {
	...
	private void SettlerDrillTest()
	{
		...
		case 0:
			...
			break;
		case 1:
			System.out.println("Az aszteroid�ban ur�n van?");
			System.out.println("0. Igen");
			System.out.println("1. Nem");
			...
			case 1:
				...
				break;
			case 0:
				System.out.println("Napk�zelben van?");
				System.out.println("0. Igen");
				System.out.println("1. Nem");
				switch(this.inputmanager())
				{
	...
	private void SunStormStartsTest() {
		...
		System.out.println("Mennyit mutat a sug�rz�sm�r�?\n");
		System.out.println("0-6 k�z�tt: 0 ");
		System.out.println("7-10 k�z�tt: 1\n");
		
		Map m = new Map();
		switch(this.inputmanager())
		{
		case 0:
			System.out.println("m�g nem k�vetkezett be napvihar\n");
			this.TestMgr();
			break;
		case 1:
			m.StartSunstorm();
			System.out.println("Napvihar az aszteroid�ban\n");
			this.TestMgr();
			break;
		default:
			this.TestMgr();	
